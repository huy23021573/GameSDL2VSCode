...
void ExplosionObject::Show(SDL_Renderer* screen)
{
	...
	SDL_Rect renderQuad = {rect_.x, rect_.y, frame_width_, frame_heigh_};
	if (currentClip != NULL)
	{
